...
# version from the Go module pin, the single source of truth that
# check-versions.sh enforces everything else against.
#
# Exports:
...
# handles tags and abbreviated SHAs alike.
