...
# this script.
#
# These are the implementation's own tests. The cross-language wire-format
# conformance suite is not part of this repo. For the on-chain end-to-end test,
# use ./scripts/test.sh.
#
# Usage:
#   ./scripts/test-unit.sh              # the LANGUAGE from .env
#   ./scripts/test-unit.sh go           # a specific language
