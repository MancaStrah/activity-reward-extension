module activity-reward-extension/tools

go 1.25.1

// Build with go1.25.13+: earlier 1.25.x patch levels carry stdlib security advisories
// flagged by govulncheck. `go run ./cmd/...` will select this toolchain automatically.
toolchain go1.25.13
